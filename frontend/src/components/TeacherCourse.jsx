      ...
      <Container maxW="container.xl">
        <VStack spacing={8} align="stretch">
          <Flex justifyContent="space-between" alignItems="center">
            <Heading as="h1" size="2xl" className="text-indigo-600">
              Your Courses
            </Heading>
            <Button
              leftIcon={<AddIcon />}
          ...
          <Modal isOpen={isModalOpen} onClose={() => setIsModalOpen(false)}>
            ...
            <ModalContent>
              ...
              <ModalFooter>
                <Button className="!bg-indigo-600 !text-white" onClick={editingCourseId ? handleUpdateCourse : handleCreateCourse}>
